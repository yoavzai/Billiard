    ...
    return (
        <div className="player_container">
            ...
            <div className="buttons_container">
                <button className="button" onClick={editPlayer}>ערוך</button>
            </div>
            {isUpdatePlayer &&
                ...
                <form>
                    <div className="text_input_container">
                        ...
                        <input  className={`${isUpdatePlayerErrorMessage ? "error_input" : ""}`}
                                name="name" type="text" value={playerNewData.name}
                    ...
                    <div className="select_container">
                        ...
                        <select value={playerNewData.ranking} name="ranking-select"
                    ...
                    <div className="buttons_container">
                        <input disabled={playerNewData.name.length === 0 ? true : false} className="button" type="button" onClick={updatePlayerData} value="עדכן"></input>
                        <input className="button" type="button" onClick={cancelEditPlayer} value="בטל"></input>
                    </div>
                </form>
            </div>
            }
